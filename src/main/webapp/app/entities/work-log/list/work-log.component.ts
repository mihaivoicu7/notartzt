...
export class WorkLogComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.workLogService
      ...
      .subscribe({
        next: (res: HttpResponse<IWorkLog[]>) => {
  ...
  trackId(_index: number, item: IWorkLog): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IWorkLog[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
