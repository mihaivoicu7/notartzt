...
export class ShiftComponent implements OnInit {
  ...
  trackId(_index: number, item: IShift): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IShift[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
